...
/*
* brackets-file-format - brackets extension to format or minify text in XML, JSON, CSS, HQL and SQL file type.
        ...
        hql: function(text) {
            ...
            for(ix=0;ix<len;ix++) {
                if(ix%2) {
                    ...
                    ar = ar.concat(split_hql(ar_by_quote[ix], tab) );
                }
            }
